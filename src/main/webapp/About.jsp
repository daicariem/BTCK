...
<body>
	<div style="background-color: #ff5733; padding: 64px; color: #fff;" id="about">
...
<div id="slideshow-container" style="max-width: 800px; margin: 0 auto;">
  ...
  <img class="mySlides" src="https://file.hstatic.net/200000134651/file/1f991f969025621fb2dee8ed2a82f34e_940aa9c830f94ec1980c8da92816a5aa_grande.jpg" style="width: 100%;">
...
$(document).ready(function() {
  ...
  function showSlides() {
    ...
    setTimeout(showSlides, 5000); // Thay đổi ảnh sau mỗi 5 giây
  }
